    ...
    <div className="min-h-screen p-5 grid text-center place-content-center bg-white">
      <div className="max-w-[450px]">
        <Link href="/" className="flex justify-center items-center gap-3 mb-6">
          ...
          <Ty tag="h1" variant="h2">Slack clone</Ty>
        </Link>

        <Ty tag="p" variant="h3" className="mb-6">Sign in to your slack</Ty>

        <div className="flex flex-col space-y-4">
          <Link href="/auth/google" disabled={isAuthenticating} variant="outline" className={cn(buttonVariants({ variant: "outline", className: "py-6 border-2 flex space-x-3" }))}>
            <FcGoogle />
            <Ty className="text-xl">Sign in with Google</Ty>
          </Link>
          <Link href="/auth/github" disabled={isAuthenticating} variant="outline" className={cn(buttonVariants({ variant: "outline", className: "py-6 border-2 flex space-x-3" }))}>
            <RxGithubLogo />
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <fieldset disabled={isAuthenticating}>
              ...
              <Button variant="secondary" className="bg-primary hover:bg-primary/90 w-full my-5 text-white" type="submit">
